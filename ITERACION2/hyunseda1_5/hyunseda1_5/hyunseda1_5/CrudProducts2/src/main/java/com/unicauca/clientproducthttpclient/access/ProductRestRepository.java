...
public class ProductRestRepository implements IProductRepository {
    ...
    public List<Product> findAll() {
        ...
        try {
            ...
            String apiUrl = "http://localhost:8090/products";
...
public Product findById(long id) {
    ...
    try {
        String apiUrl = "http://localhost:8090/products/" + id;
        HttpGet request = new HttpGet(apiUrl);
        HttpResponse response = httpClient.execute(request);
        int statusCode = response.getStatusLine().getStatusCode();
    ...
    public void edit(long id, Product productUpdated) {
        ...
        try {
            ...
            String url = "http://localhost:8090/products/" + id; // URL del producto a actualizar
            ...
            product2.setCreateAt(productUpdated.getCreateAt());
    ...
    public void delete(long id) {
        ...
        try {
            ...
            String url = "http://localhost:8090/products/" + id; // URL del producto a eliminar
    ...
    try {           
        String apiUrl = "http://localhost:8090/products/by-name/" + name;
        HttpGet request = new HttpGet(apiUrl);
        HttpResponse response = httpClient.execute(request);
        int statusCode = response.getStatusLine().getStatusCode();
