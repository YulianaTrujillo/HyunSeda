...
public class CategoryRestRepository implements ICategoryRepository {
    ...
    public List<Category> findAll() {
        ...
        try {
            ...
            String apiUrl = "http://localhost:8090/categories";
    ...
    public void create(Category category) {
         ...
         //resivimos una categoria creada.
        try {
            ...
            // Crear un objeto Producto, ojo en este caso estamos resibiendo
           ...
           JOptionPane.showMessageDialog(null, "categoria creado exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            ...
            Logger.getLogger(ProductRestRepository.class
    ...
    public void edit(long id, Category categoryUpdated) {
        ...
        try {
            ...
            String url = "http://localhost:8090/categories/" + id; // URL del producto a actualizar
    ...
    public void delete(long id) {
        try {
            ...
            String url = "http://localhost:8090/categories/" + id; // URL del producto a eliminar
